<div class="box box-primary">
    <div class="box-header with-border">
        <h3>Cuti Tahunan</h3>
            ...
            <!-- form start -->
     <form method="POST" action="<?= base_url('karyawan/proses_input_cuty_tahunan')?>" enctype="multipart/form-data">
        <div class="box-body">
            <div class="form-group">
                <label>Jenis Permohonan Cuti</label>
                <input type="text" class="form-control" name="jenis_cuty" value="Tahunan" readonly>
            </div>
