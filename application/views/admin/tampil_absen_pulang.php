              ...
              <table id="table1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr class="gradeX">
                          ...
                          <td align="center">  &nbsp;
                               <a class="delete-row" data-original-title="Delete" href="index.php/admin/hapus_absen_plg/<?php echo $row->kd_absen; ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus Data" >
